              ...
              <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
                <SheetTrigger asChild>
                  <Button
                    variant="default"
                    size="lg"
                    className="bg-accent hover:bg-accent/90 text-navy font-semibold transition-all duration-300 transform hover:scale-105"
                  >
                    Apply Now
                  </Button>
                </SheetTrigger>
                <SheetContent className="overflow-y-auto w-full sm:max-w-lg">
                  <SheetHeader className="mb-6 text-left">
                    ...
                    <SheetDescription>
                      Please fill out the form below to start the admission process. Our team will contact you shortly.
                    </SheetDescription>
                  </SheetHeader>
